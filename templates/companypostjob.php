<div ng-controller="companypostjobCtrl">
	<br>
	<form id="companypostform">
	  <fieldset>
	    ...
	    <button type="submit" id="companypostjobsubmit" class="btn btn-primary">Submit</button>
	    
	    <font id="postinfomsg" color="red"></font>
