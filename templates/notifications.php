<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#/notifications">Company Notifications</a>
  </li>
</ul>

<div ng-controller="notificationsCtrl">
	<br>
	<legend>Job recommendations from companies</legend>
	<form >
	<table class="table table-hover">
	  ...
	  <tbody>
	    <tr ng-repeat="r in notifications.info">
	      <td>{{r.cname}}</td>
	      <td>{{r.jtitle}}</td>
	      <td>{{r.jcity}}</td>
	      <td>{{r.jstate}}</td>
